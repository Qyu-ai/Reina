...
estimator_11 = baseModel(model="LinearRegression", labelCol=outcome)
estimator_10 = baseModel(model="LinearRegression", labelCol=outcome)
estimator_21 = baseModel(model="LinearRegression", labelCol="imputed_treatment")
estimator_20 = baseModel(model="LinearRegression", labelCol="imputed_treatment")
propensity_estimator = baseModel(model="RandomForestClassifier", labelCol='treatment')
estimators = {"estimator_11":estimator_11, 
              "estimator_10":estimator_10,
              "estimator_21":estimator_21,
              "estimator_20":estimator_20,
              "propensity_estimator":propensity_estimator}

spark_meta_learner = SparkMetaLearner(learner='X')
...
print('========================================== X-learner Time (Spark): ', stop - start)  
print("========================================== X-learner ATE:", spark_meta_learner.average_treatment_effects)
