...
estimator = baseModel(model="LinearRegression", labelCol=outcome)
spark_meta_learner = SparkMetaLearner(learner='S')

import timeit
start = timeit.default_timer()
spark_meta_learner.fit(data=df, treatments=treatments, outcome=outcome, estimators={"estimator":estimator})
stop = timeit.default_timer()

print('========================================== S-learner Time (Spark): ', stop - start)  
print("========================================== S-learner ATE:", spark_meta_learner.average_treatment_effects)
