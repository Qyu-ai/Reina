...
outcome = 'outcome'
estimator_11 = baseModel(model="RandomForestRegressor", labelCol=outcome)
estimator_10 = baseModel(model="RandomForestRegressor", labelCol=outcome)
estimator_21 = baseModel(model="RandomForestRegressor", labelCol="imputed_treatment")
estimator_20 = baseModel(model="RandomForestRegressor", labelCol="imputed_treatment")
propensity_estimator = baseModel(model="RandomForestClassifier", labelCol=treatments[0])
...
_, ate = spark_xlearner.effects(X=df, treatment=treatments[0])
print('========================================== X-learner Time (Spark): ', stop - start)  
print("========================================== X-learner ATE:", ate)
